...
BENCHMARK = [
    ...
    },
    {
        ...
        "gold": "Được hiểu là đã bao gồm mọi chi phí liên quan như thuế, phí đóng gói, phí vận chuyển (Điều 31 khoản 2).",
    ...
    },
    {
        ...
        "gold": "Sau 12 giờ kể từ khi khách hàng gửi đề nghị mà không được trả lời thì đề nghị chấm dứt hiệu lực (Điều 20 khoản 2).",
